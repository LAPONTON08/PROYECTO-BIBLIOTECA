...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO editorial (nombre_editorial) VALUES (%s)",
...
<form action="<?php echo $editFormAction; ?>" method="post" name="form1" id="form1">
  <table align="left" cellpadding="5" cellspacing="0" class="form">
    <tr valign="baseline" bgcolor="#CCCCCC">
      <th  colspan="2"  nowrap="nowrap" class="color-textotabla"> REGISTRO DE EDITORIALES</span></th>
    </tr>
    <tr valign="baseline" bgcolor="#FEFFEE">
      <td align="right" nowrap="nowrap"><span class="texto_tabla">NOMBRE:</span></td>
      <td height="38" align="left" nowrap="nowrap"><input name="nombre_editorial" type="text"  size="32" required /></td>
    </tr>
    <tr valign="baseline" bgcolor="#FEFFEE">
      <td align="left" nowrap="nowrap">&nbsp;</td>
      <td align="left" nowrap="nowrap"><input name="submit" type="submit" value="Nuevo registro" class="boton"   /></td>
    </tr>
  </table>
